...
<div class="absolute inset-0 pointer-events-none overflow-hidden flow-lines">
    <svg class="absolute inset-0 w-full h-full" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M -100 320 C 200 280, 400 180, 600 220 S 900 340, 1300 260" stroke="url(#flow-amber)" stroke-width="1" />
        <path d="M -100 350 C 200 310, 420 200, 620 240 S 920 370, 1300 290" stroke="url(#flow-amber)" stroke-width="0.5" opacity="0.6" />

        {{-- Secondary curves - teal to indigo --}}
        <path d="M -50 480 C 250 420, 500 520, 750 460 S 1000 380, 1300 430" stroke="url(#flow-teal)" stroke-width="1" />
        <path d="M -50 510 C 260 450, 510 540, 760 480 S 1010 400, 1300 455" stroke="url(#flow-teal)" stroke-width="0.5" opacity="0.5" />

        {{-- Tertiary - counter-flow from right --}}
        <path d="M 1300 180 C 1000 220, 800 140, 550 200 S 200 280, -100 220" stroke="url(#flow-indigo)" stroke-width="0.75" />

        {{-- Subtle background lines for depth --}}
        <path d="M -100 150 C 300 120, 500 200, 800 160 S 1100 100, 1300 140" stroke="url(#flow-subtle)" stroke-width="0.5" />
        <path d="M -100 600 C 300 560, 600 640, 900 580 S 1100 520, 1300 570" stroke="url(#flow-subtle)" stroke-width="0.5" />
        <path d="M -100 700 C 400 680, 600 720, 900 690 S 1100 660, 1300 680" stroke="url(#flow-subtle)" stroke-width="0.5" />
    </svg>
</div>
@elseif($variant === 'card')
<div class="absolute inset-0 pointer-events-none overflow-hidden flow-lines">
