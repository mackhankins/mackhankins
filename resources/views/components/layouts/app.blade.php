        ...
        <div class="max-w-6xl mx-auto px-6 py-12">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="flex items-center gap-6">
                    ...
                    <a href="https://twitter.com/mackhankins" target="_blank" rel="noopener noreferrer"
                    ...
                    <a href="https://linkedin.com/in/mackhankins" target="_blank" rel="noopener noreferrer"
