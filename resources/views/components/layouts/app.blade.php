    ...
    <nav class="fixed top-0 inset-x-0 z-40 border-b border-base-700/50 bg-base-900/80 backdrop-blur-xl">
        <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <div class="flex md:hidden items-center gap-2">
                ...
                <button id="mobile-nav-toggle" class="text-base-300 hover:text-base-50 transition-colors" aria-label="Toggle navigation" aria-expanded="false">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="flex items-center gap-6">
                    ...
                    <a href="{{ route('feeds.main') }}"
                       class="text-base-400 hover:text-amber-accent transition-colors" aria-label="RSS Feed">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M6.18 15.64a2.18 2.18 0 012.18 2.18C8.36 19.01 7.37 20 6.18 20 5 20 4 19.01 4 17.82a2.18 2.18 0 012.18-2.18M4 4.44A15.56 15.56 0 0119.56 20h-2.83A12.73 12.73 0 004 7.27V4.44m0 5.66a9.9 9.9 0 019.9 9.9h-2.83A7.07 7.07 0 004 12.93V10.1z"/></svg>
                    </a>
                </div>
