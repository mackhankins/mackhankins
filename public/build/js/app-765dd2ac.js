...
!function (e) {
    ...
    function l(e) {
        ...
        function a(i, o) {
            if (!i.compiled) {
                ...
                i.lR = r(i.l || /\b\w+\b/, !0), o && (i.bK && (i.b = "\\b(" + i.bK.split(" ").join("|") + ")\\b"), i.b || (i.b = /\B|\b/), i.bR = r(i.b), i.e || i.eW || (i.e = /\B|\b/), i.e && (i.eR = r(i.e)), i.tE = t(i.e) || "", i.eW && o.tE && (i.tE += (i.e ? "|" : "") + o.tE)), i.i && (i.iR = r(i.i)), void 0 === i.r && (i.r = 1), i.c || (i.c = []);
                var c = [];
    ...
    function c(e, r, i, n) {
        ...
        function b() {
            ...
            var e = "", r = 0;
            w.lR.lastIndex = 0;
            for (var a = w.lR.exec(D); a;) {
                e += t(D.substr(r, a.index - r));
                var i = u(w, a);
                i ? (M += i[1], e += m(i[0], t(a[0]))) : e += t(a[0]), r = w.lR.lastIndex, a = w.lR.exec(D)
            }
            return e + t(D.substr(r))
        }

        function g() {
            if (w.sL && !x[w.sL])return t(D);
            var e = w.sL ? c(w.sL, D, !0, N[w.sL]) : d(D);
        ...
        function h(e, r) {
            var a = e.cN ? m(e.cN, "", !0) : "";
            e.rB ? (k += a, D = "") : e.eB ? (k += t(r) + a, D = "") : (k += a, D = r), w = Object.create(e, {parent: {value: w}})
        }

        function v(e, r) {
            if (D += e, void 0 === r)return k += f(), 0;
            var a = o(r, w);
            if (a)return k += f(), h(a, r), a.rB ? 0 : r.length;
            var i = s(w, r);
            if (i) {
                var n = w;
                n.rE || n.eE || (D += r), k += f();
                do w.cN && (k += "</span>"), M += w.r, w = w.parent; while (w != i.parent);
                return n.eE && (k += t(r)), D = "", i.starts && h(i.starts, ""), n.rE ? 0 : r.length
            }
            if (p(r, w))throw new Error('Illegal lexeme "' + r + '" for mode "' + (w.cN || "<unnamed>") + '"');
            return D += r, r.length || 1
        }
        ...
        l(C);
        var S, w = n || C, N = {}, k = "";
        for (S = w; S != C; S = S.parent)S.cN && (k = m(S.cN, "", !0) + k);
        var D = "", M = 0;
        try {
            for (var T, E, A = 0; ;) {
                if (w.t.lastIndex = A, T = w.t.exec(r), !T)break;
                E = v(r.substr(A, T.index - A), T[0]), A = T.index + E
            }
            for (v(r.substr(A)), S = w; S.parent; S = S.parent)S.cN && (k += "</span>");
            return {r: M, value: k, language: e, top: w}
        } catch (L) {
    ...
    function m(e) {
        ...
        if (!/no(-?)highlight|plain|text/.test(t)) {
            ...
            var a = r.textContent, n = t ? c(t, a, !0) : d(a), l = o(r);
            if (l.length) {
                var m = document.createElementNS("http://www.w3.org/1999/xhtml", "div");
                m.innerHTML = n.value, n.value = s(l, o(m), a)
            }
            n.value = p(n.value), e.innerHTML = n.value, e.className = u(e.className, t, n.language), e.result = {
                language: n.language,
                re: n.r
    ...
    var y = {classPrefix: "hljs-", tabReplace: null, useBR: !1, languages: void 0}, x = {}, C = {};
    return e.highlight = c, e.highlightAuto = d, e.fixMarkup = p, e.highlightBlock = m, e.configure = b, e.initHighlighting = g, e.initHighlightingOnLoad = f, e.registerLanguage = h, e.listLanguages = v, e.getLanguage = _, e.inherit = n, e.IR = "[a-zA-Z]\\w*", e.UIR = "[a-zA-Z_]\\w*", e.NR = "\\b\\d+(\\.\\d+)?", e.CNR = "\\b(0[xX][a-fA-F0-9]+|(\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", e.BNR = "\\b(0b[01]+)", e.RSR = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", e.BE = {
        b: "\\\\[\\s\\S]",
        r: 0
        ...
        i: "\\n",
        c: [e.BE]
    }, e.PWM = {b: /\b(a|an|the|are|I|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such)\b/}, e.C = function (t, r, a) {
        var i = e.inherit({cN: "comment", b: t, e: r, c: []}, a || {});
        return i.c.push(e.PWM), i
    ...
    var t = e.inherit(e.QSM, {i: ""}), r = {
        ...
        e: "\\)",
        c: ["self", e.CNM, t]
    }, a = e.C("--", "$"), i = e.C("\\(\\*", "\\*\\)", {c: ["self", a]}), n = [a, i, e.HCM];
    return {
        aliases: ["osascript"],
        k: {
    ...
    var t = {cN: "escape", b: "`[\\s\\S]"}, r = e.C(";", "$", {r: 0}), a = [{
        cN: "built_in",
        b: "A_[a-zA-Z0-9]+"
    ...
    var t = {built_in: "def cond apply if-not if-let if not not= = < > <= >= == + / * - rem quot neg? pos? delay? symbol? keyword? true? false? integer? empty? coll? list? set? ifn? fn? associative? sequential? sorted? counted? reversible? number? decimal? class? distinct? isa? float? rational? reduced? ratio? odd? even? char? seq? vector? string? map? nil? contains? zero? instance? not-every? not-any? libspec? -> ->> .. . inc compare do dotimes mapcat take remove take-while drop letfn drop-last take-last drop-while while intern condp case reduced cycle split-at split-with repeat replicate iterate range merge zipmap declare line-seq sort comparator sort-by dorun doall nthnext nthrest partition eval doseq await await-for let agent atom send send-off release-pending-sends add-watch mapv filterv remove-watch agent-error restart-agent set-error-handler error-handler set-error-mode! error-mode shutdown-agents quote var fn loop recur throw try monitor-enter monitor-exit defmacro defn defn- macroexpand macroexpand-1 for dosync and or when when-not when-let comp juxt partial sequence memoize constantly complement identity assert peek pop doto proxy defstruct first rest cons defprotocol cast coll deftype defrecord last butlast sigs reify second ffirst fnext nfirst nnext defmulti defmethod meta with-meta ns in-ns create-ns import refer keys select-keys vals key val rseq name namespace promise into transient persistent! conj! assoc! dissoc! pop! disj! use class type num float double short byte boolean bigint biginteger bigdec print-method print-dup throw-if printf format load compile get-in update-in pr pr-on newline flush read slurp read-line subvec with-open memfn time re-find re-groups rand-int rand mod locking assert-valid-fdecl alias resolve ref deref refset swap! reset! set-validator! compare-and-set! alter-meta! reset-meta! commute get-validator alter ref-set ref-history-count ref-min-history ref-max-history ensure sync io! new next conj set! to-array future future-call into-array aset gen-class reduce map filter find empty hash-map hash-set sorted-map sorted-map-by sorted-set sorted-set-by vec vector seq flatten reverse assoc dissoc list disj get union difference intersection extend extend-type extend-protocol int nth delay count concat chunk chunk-buffer chunk-append chunk-first chunk-rest max min dec unchecked-inc-int unchecked-inc unchecked-dec-inc unchecked-dec unchecked-negate unchecked-add-int unchecked-add unchecked-subtract-int unchecked-subtract chunk-next chunk-cons chunked-seq? prn vary-meta lazy-seq spread list* str find-keyword keyword symbol gensym force rationalize"}, r = "a-zA-Z_\\-!.?+*=<>&#'", a = "[" + r + "][" + r + "0-9/;:]*", i = "[-+]?\\d+(\\.\\d+)?", n = {
        b: a,
        r: 0
    }, o = {cN: "number", b: i, r: 0}, s = e.inherit(e.QSM, {i: null}), l = e.C(";", "$", {r: 0}), c = {
        cN: "literal",
        b: /\b(true|false|nil)\b/
    }, d = {cN: "collection", b: "[\\[\\{]", e: "[\\]\\}]"}, p = {
        cN: "comment",
        b: "\\^" + a
    }, u = e.C("\\^\\{", "\\}"), m = {cN: "attribute", b: "[:]" + a}, b = {cN: "list", b: "\\(", e: "\\)"}, g = {
        eW: !0,
        r: 0
    }, f = {k: t, l: a, cN: "keyword", b: a, starts: g}, h = [b, s, p, u, l, m, d, o, c, n];
    ...
    var t = "[a-zA-Z-][a-zA-Z0-9_-]*", r = {cN: "function", b: t + "\\(", rB: !0, eE: !0, e: "\\("}, a = {
        cN: "rule",
        b: /[A-Z\_\.\-]+\s*:/,
        rB: !0,
        e: ";",
    ...
    return {
        ...
        }, {cN: "tag", b: t, r: 0}, {cN: "rules", b: "{", e: "}", i: /\S/, r: 0, c: [e.CBCM, a]}]
    }
    ...
    var t = {
    ...
    }, r = "(0|[1-9][\\d_]*)", a = "(0|[1-9][\\d_]*|\\d[\\d_]*|[\\d_]+?\\d)", i = "0[bB][01_]+", n = "([\\da-fA-F][\\da-fA-F_]*|_[\\da-fA-F][\\da-fA-F_]*)", o = "0[xX]" + n, s = "([eE][+-]?" + a + ")", l = "(" + a + "(\\.\\d*|" + s + ")|\\d+\\." + a + a + "|\\." + r + s + "?)", c = "(0[xX](" + n + "\\." + n + "|\\.?" + n + ")[pP][+-]?" + a + ")", d = "(" + r + "|" + i + "|" + o + ")", p = "(" + c + "|" + l + ")", u = "\\\\(['\"\\?\\\\abfnrtv]|u[\\dA-Fa-f]{4}|[0-7]{1,3}|x[\\dA-Fa-f]{2}|U[\\dA-Fa-f]{8})|&[a-zA-Z\\d]{2,};", m = {
        cN: "number",
        b: "\\b" + d + "(L|u|U|Lu|LU|uL|UL)?",
        r: 0
    }, b = {cN: "number", b: "\\b(" + p + "([fF]|L|i|[fF]i|Li)?|" + d + "(i|[fF]i|Li))", r: 0}, g = {
        cN: "string",
        b: "'(" + u + "|.)",
        e: "'",
        i: "."
    }, f = {b: u, r: 0}, h = {cN: "string", b: '"', c: [f], e: '"[cwd]?'}, v = {
        cN: "string",
        b: '[rq]"',
        e: '"[cwd]?',
        r: 5
        ...
        b: 'x"[\\da-fA-F\\s\\n\\r]*"[cwd]?',
        r: 10
    }, x = {cN: "string", b: 'q"\\{', e: '\\}"'}, C = {cN: "shebang", b: "^#!", e: "$", r: 5}, S = {
        cN: "preprocessor",
        b: "#(line)",
        e: "$",
        r: 5
    }, w = {cN: "keyword", b: "@[a-zA-Z_][a-zA-Z_\\d]*"}, N = e.C("\\/\\+", "\\+\\/", {c: ["self"], r: 10});
    return {l: e.UIR, k: t, c: [e.CLCM, e.CBCM, N, y, h, v, _, x, b, m, g, C, S, w]}
    ...
    var t = "exports register file shl array record property for mod while set ally label uses raise not stored class safecall var interface or private static exit index inherited to else stdcall override shr asm far resourcestring finalization packed virtual out and protected library do xorwrite goto near function end div overload object unit begin string on inline repeat until destructor write message program with read initialization except default nil if case cdecl in downto threadvar of try pascal const external constructor type public then implementation finally published procedure", r = [e.CLCM, e.C(/\{/, /\}/, {r: 0}), e.C(/\(\*/, /\*\)/, {r: 10})], a = {
        ...
        c: [e.TM, {cN: "params", b: /\(/, e: /\)/, k: t, c: [a, i]}].concat(r)
    };
    return {cI: !0, k: t, i: /"|\$[G-Zg-z]|\/\*|<\/|\|/, c: [a, i, e.NM, n, o].concat(r)}
    ...
    var t = "[a-zA-Z_][a-zA-Z0-9_]*(\\!|\\?)?", r = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?", a = "and false then defined module in return redo retry end for true self when next until do begin unless nil break not case cond alias while ensure or include use alias fn quote", i = {
        ...
        e: /\bdo\b|$|;/
    }), l = [n, e.HCM, s, o, {cN: "constant", b: "(\\b[A-Z_]\\w*(.)?)+", r: 0}, {
        cN: "symbol",
        b: ":",
        c: [n, {b: r}],
        r: 0
    ...
    var t = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?", r = "and false then defined module in return redo if BEGIN retry end for true self when next until do begin unless END rescue nil else break undef not super class case require yield alias while ensure elsif or include attr_reader attr_writer attr_accessor", a = {
        cN: "yardoctag",
        b: "@[A-Za-z]+"
    }, i = {cN: "value", b: "#<", e: ">"}, n = [e.C("#", "$", {c: [a]}), e.C("^\\=begin", "^\\=end", {
        c: [a],
        r: 10
    ...
    }, {cN: "function", bK: "def", e: " |$|;", r: 0, c: [e.inherit(e.TM, {b: t}), l].concat(n)}, {
        cN: "constant",
        b: "(::)?(\\b[A-Z]\\w*(::)?)+",
        r: 0
    ...
    o.c = c, l.c = c;
    var d = "[>?]>", p = "[\\w#]+\\(\\w+\\):\\d+:\\d+>", u = "(\\w+-)?\\d+\\.\\d+\\.\\d(p\\d+)?[^>]+>", m = [{
        b: /^\s*=>/,
        cN: "status",
        starts: {e: "$", c: c}
    }, {cN: "prompt", b: "^(" + d + "|" + p + "|" + u + ")", starts: {e: "$", c: c}}];
    ...
    var t = "[a-z'][a-zA-Z0-9_']*", r = "(" + t + ":" + t + "|" + t + ")", a = {
        ...
        b: "\\b_([A-Z][A-Za-z0-9_]*)?",
        r: 0
    }, d = {cN: "variable", b: "[A-Z][a-zA-Z0-9_]*", r: 0}, p = {
        b: "#" + e.UIR,
        r: 0,
        rB: !0,
        c: [{cN: "record_name", b: "#" + e.UIR, r: 0}, {b: "{", e: "}", r: 0}]
    }, u = {bK: "fun receive if try case", e: "end", k: a};
    u.c = [i, o, e.inherit(e.ASM, {cN: ""}), u, s, e.QSM, n, l, c, d, p];
    ...
    var t = "[A-Z_][A-Z0-9_.]*", r = "\\%", a = {
        ...
        cN: "preprocessor",
        b: "([O])([0-9]+)"
    }, n = [e.CLCM, e.CBCM, e.C(/\(/, /\)/), e.inherit(e.CNM, {b: "([-+]?([0-9]*\\.?[0-9]+\\.?))|" + e.CNR}), e.inherit(e.ASM, {i: null}), e.inherit(e.QSM, {i: null}), {
        cN: "keyword",
        b: "([G])([0-9]+\\.?[0-9]?)"
    ...
    return {
        ...
        c: [{
            ...
            c: [{cN: "begin-block", b: "#[a-zA-Z- .]+", k: t}, {cN: "string", b: '"', e: '"'}, {
                ...
                b: "\\/[a-zA-Z- .]+",
                k: t
            }, {cN: "variable", b: "[a-zA-Z-.]+", k: t}]
        }]
    }
}), hljs.registerLanguage("haskell", function (e) {
    var t = [e.C("--", "$"), e.C("{-", "-}", {c: ["self"]})], r = {
        cN: "pragma",
        b: "{-#",
        e: "#-}"
        ...
        c: [r, a, {
            cN: "type",
            b: "\\b[A-Z][\\w]*(\\((\\.\\.|,|\\w+)\\))?"
        }, e.inherit(e.TM, {b: "[_a-z][\\w']*"})].concat(t)
    ...
    return {
        ...
        c: [{
            ...
            c: [r, i, n, o].concat(t)
        }, {cN: "default", bK: "default", e: "$", c: [i, n].concat(t)}, {
            cN: "infix",
            ...
            e: "$"
        }, r, a, e.QSM, e.CNM, i, e.inherit(e.TM, {b: "^[_a-z][\\w']*"}), {b: "->|<-"}].concat(t)
    }
    ...
    var t = {
    ...
    }, r = "[A-Za-z_\\u00A1-\\uFFFF][A-Za-z_0-9\\u00A1-\\uFFFF]*", a = {l: r, k: t}, i = {
        cN: "type-annotation",
        b: /::/
    }, n = {cN: "subtype", b: /<:/}, o = {
        cN: "number",
        ...
        c: [e.BE, l, c],
        v: [{b: /\w*"/, e: /"\w*/}, {b: /\w*"""/, e: /"""\w*/}]
    }, p = {cN: "string", c: [e.BE, l, c], b: "`", e: "`"}, u = {cN: "macrocall", b: "@" + r}, m = {
        cN: "comment",
        v: [{b: "#=", e: "=#", r: 10}, {b: "#", e: "$"}]
    };
    ...
    return a.push(e.CLCM, e.CBCM, u, m, b, p), {cI: !0, i: "[=>'/<($\"]", c: a}
}), hljs.registerLanguage("lisp", function (e) {
    var t = "[a-zA-Z_\\-\\+\\*\\/\\<\\=\\>\\&\\#][a-zA-Z0-9_\\-\\+\\*\\/\\<\\=\\>\\&\\#!]*", r = "\\|[^]*?\\|", a = "(\\-|\\+)?\\d+(\\.\\d+|\\/\\d+)?((d|e|f|l|s|D|E|F|L|S)(\\+|\\-)?\\d+)?", i = {
        cN: "shebang",
        b: "^#!",
        e: "$"
        ...
        b: "\\*",
        e: "\\*"
    }, d = {cN: "keyword", b: "[:&]" + t}, p = {b: t, r: 0}, u = {b: r}, m = {
        b: "\\(",
        e: "\\)",
        c: ["self", n, s, o, p]
    }, b = {
    ...
    }, g = {cN: "quoted", v: [{b: "'" + t}, {b: "#'" + t + "(::" + t + ")*"}]}, f = {
        cN: "list",
        b: "\\(\\s*",
        e: "\\)"
    }, h = {eW: !0, r: 0};
    return f.c = [{cN: "keyword", v: [{b: t}, {b: r}]}, h], h.c = [b, g, f, n, o, s, l, c, d, u, p], {
        i: /\S/,
        c: [o, i, n, s, l, b, g, f, p]
    }
    ...
    var t = {
        ...
        r: 0
    }, r = [e.CBCM, e.HCM, e.C("--", "$"), e.C("[^:]//", "$")], a = e.inherit(e.TM, {v: [{b: "\\b_*rig[A-Z]+[A-Za-z0-9_\\-]*"}, {b: "\\b_[a-z0-9\\-]+"}]}), i = e.inherit(e.TM, {b: "\\b([A-Za-z0-9_\\-]+)\\b"});
    return {
        cI: !1,
        k: {
        ...
        c: [t, {cN: "keyword", b: "\\bend\\sif\\b"}, {
            ...
            b: "<\\?rev|<\\?lc|<\\?livecode",
            r: 10
        }, {cN: "preprocessor", b: "<\\?"}, {cN: "preprocessor", b: "\\?>"}, e.ASM, e.QSM, e.BNM, e.CNM, a].concat(r),
        i: ";$|^\\[|^="
    }
    ...
    return {
        ...
        c: [{
            ...
            r: 0,
            starts: r
        }, {b: /\)/, r: 0, starts: r}, e.C("^\\s*\\%\\{\\s*$", "^\\s*\\%\\}\\s*$"), e.C("\\%", "$")].concat(t)
    }
    ...
    var c = {
        cN: "built_in",
        v: [{b: "<=>"}, {b: "<=", r: 0}, {b: "=>", r: 0}, {b: "/\\\\"}, {b: "\\\\/"}]
    }, d = {cN: "built_in", v: [{b: ":-\\|-->"}, {b: "=", r: 0}]};
    return {aliases: ["m", "moo"], k: t, c: [c, d, a, i, n, e.NM, o, s, {b: /:-/}]}
    ...
    return {
        ...
        c: [{cN: "decorator", b: /{\./, e: /\.}/, r: 10}, {
            ...
            e: /"/,
            c: [{b: /""/}]
        }, {cN: "string", b: /([a-zA-Z]\w*)?"""/, e: /"""/}, e.QSM, {cN: "type", b: /\b[A-Z]\w+\b/, r: 0}, {
            cN: "type",
    ...
    var t = "abstract add and array as asc aspect assembly async begin break block by case class concat const copy constructor continue create default delegate desc distinct div do downto dynamic each else empty end ensure enum equals event except exit extension external false final finalize finalizer finally flags for forward from function future global group has if implementation implements implies in index inherited inline interface into invariants is iterator join locked locking loop matching method mod module namespace nested new nil not notify nullable of old on operator or order out override parallel params partial pinned private procedure property protected public queryable raise read readonly record reintroduce remove repeat require result reverse sealed select self sequence set shl shr skip static step soft take then to true try tuple type union unit unsafe until uses using var virtual raises volatile where while with write xor yield await mapped deprecated stdcall cdecl pascal register safecall overload library platform reference packed strict published autoreleasepool selector strong weak unretained", r = e.C("{", "}", {
        r: 0
    }), a = e.C("\\(\\*", "\\*\\)", {r: 10}), i = {cN: "string", b: "'", e: "'", c: [{b: "''"}]}, n = {
        cN: "string",
        b: "(#\\d+)+"
    }, o = {
        cN: "function",
    ...
    }, n = e.C("^(__END__|__DATA__)", "\\n$", {r: 5}), o = [e.BE, r, i], s = [i, e.HCM, n, e.C("^\\=\\w", "\\=cut", {eW: !0}), a, {
        cN: "string",
        c: o,
    ...
    var t = {cN: "atom", b: /[a-z][A-Za-z0-9_]*/, r: 0}, r = {
        cN: "name",
        ...
        e: /$/,
        c: [e.PWM]
    }, o = {cN: "string", b: /`/, e: /`/, c: [e.BE]}, s = {cN: "string", b: /0\'(\\\'|.)/}, l = {
        cN: "string",
        b: /0\'\\s/
    }, c = {b: /:-/}, d = [t, r, a, c, i, n, e.CBCM, e.QSM, e.ASM, o, s, l, e.CNM];
    ...
    }, l = e.QSM, c = [e.C(";", "$", {r: 0}), e.C("#\\|", "\\|#")], d = {b: t, r: 0}, p = {
        cN: "variable",
        b: "'" + t
    }, u = {eW: !0, r: 0}, m = {
        cN: "list",
    ...
    return u.c = [o, s, l, d, p, m].concat(c), {i: /\S/, c: [n, s, l, p, m].concat(c)}
    ...
    return {
        ...
        c: [e.C('"', '"'), e.ASM, {cN: "class", b: "\\b[A-Z][A-Za-z0-9_]*", r: 0}, {
            cN: "method",
            b: t + ":",
            r: 0
        }, e.CNM, a, r, {
    ...
    var t = "[A-Z_][A-Z0-9_.]*", r = "END-ISO-10303-21;", a = {
        ...
        b: "ISO-10303-21;",
        r: 10
    }, n = [e.CLCM, e.CBCM, e.C("/\\*\\*!", "\\*/"), e.CNM, e.inherit(e.ASM, {i: null}), e.inherit(e.QSM, {i: null}), {
        cN: "string",
        b: "'",
        e: "'"
    ...
    }, r = {cN: "type", b: "\\b[A-Z][\\w']*", r: 0}, a = e.C("/\\*", "\\*/", {c: ["self"]}), i = {
        cN: "subst",
        b: /\\\(/,
        e: "\\)",
        k: t,
    ...
    var t = {cN: "command", b: "\\\\[a-zA-Zа-яА-я]+[\\*]?"}, r = {
        cN: "command",
        b: "\\\\[^a-zA-Zа-яА-я0-9]"
    }, a = {cN: "special", b: "[{}\\[\\]\\&#~]", r: 0};
    return {
        c: [{
            ...
            rB: !0,
            c: [t, r, {cN: "number", b: " *=", e: "-?\\d*\\.?\\d+(pt|pc|mm|cm|in|dd|cc|ex|em)?", eB: !0}],
            r: 10
        }, t, r, a, {cN: "formula", b: "\\$\\$", e: "\\$\\$", c: [t, r, a], r: 0}, {
            cN: "formula",
            b: "\\$",
            e: "\\$",
            c: [t, r, a],
    ...
    return n = n + " " + n.split(" ").map(function (e) {
        ...
        sL: "xml",
        subLanguageMode: "continuous",
        c: [e.C(/\{#/, /#}/), {cN: "template_tag", b: /\{%/, e: /%}/, k: n, c: [i, a]}, {
            cN: "variable",
            b: /\{\{/,
            e: /}}/,
            c: [i, a]
    ...
    var t = "\\d(_|\\d)*", r = "[eE][-+]?" + t, a = t + "(\\." + t + ")?(" + r + ")?", i = "\\w+", n = t + "#" + i + "(\\." + i + ")?#(" + r + ")?", o = "\\b(" + n + "|" + a + ")";
    return {
        cI: !0,
        k: {
        ...
        i: "{",
        c: [e.CBCM, e.C("--", "$"), e.QSM, {cN: "number", b: o, r: 0}, {
            cN: "literal",
            b: "'(U|X|0|1|Z|W|L|H|-)'",
            c: [e.BE]
    ...
    var t = "ObjectLoader Animate MovieCredits Slides Filters Shading Materials LensFlare Mapping VLCAudioVideo StereoDecoder PointCloud NetworkAccess RemoteControl RegExp ChromaKey Snowfall NodeJS Speech Charts", r = {
        ...
        r: 10
    }, d = {cN: "import", bK: "import", e: "$", k: {keyword: "import", module: t}, r: 0, c: [o]}, p = {
        cN: "function",
        b: "[a-z].*->"
    };
    return {aliases: ["tao"], l: /[a-zA-Z][a-zA-Z0-9_?]*/, k: r, c: [e.CLCM, e.CBCM, o, s, l, p, d, a, i, n, c, e.NM]}
});
